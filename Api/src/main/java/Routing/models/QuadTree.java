...
public class QuadTree {
    ...
    public HashMap<Employee, Point> query(Rectangle range) {
        HashMap<Employee, Point> found = new HashMap<Employee, Point>();
        if (!this.boundary.intersects(range)) {
            ...
            if (this.divided) {
                found.putAll(this.northeast.query(range));
                found.putAll(this.northwest.query(range));
                found.putAll(this.southeast.query(range));
                found.putAll(this.southwest.query(range));
            }
        }
        return found;
    }
